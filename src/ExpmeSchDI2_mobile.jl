...
function get_candidate_traj!(integrator, t_k, state_k, traj_nom_k, quad_key, q_num, discharge_rate, ren_state)
    ...
    comp_time_b2b = @elapsed traj_b2b_kn = ExpController.DI_get_nominal_mpc_π(state_kN_end, integrator.p[1][q_num]; t0 = t_kN, T_H_sec = 8.0, N_mpc = 160, TRAJ = "B2B", ren_point_1 = ren_state)
